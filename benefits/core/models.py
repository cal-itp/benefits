...
class EnrollmentFlow(models.Model):
    ...
    def uses_claims_verification(self):
        """True if this flow verifies eligibility via a claims provider. False otherwise."""
...
class TransitAgency(models.Model):
    ...
    def types_to_verify(self, enrollment_flow: EnrollmentFlow):
        ...
        flow_types = {enrollment_flow.eligibility_type.id}
        supported_types = list(agency_types & flow_types)
        return EligibilityType.get_many(supported_types)

    def type_names_to_verify(self, enrollment_flow: EnrollmentFlow):
        """List of names of the eligibility types to check for this agency."""
        return EligibilityType.get_names(self.types_to_verify(enrollment_flow))
