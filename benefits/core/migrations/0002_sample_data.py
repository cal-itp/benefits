...
""",
    ...
    verifier1 = EligibilityVerifier.objects.create(
        ...
        start_sub_headline=_("eligibility.pages.start.login_gov.sub_headline"),
        ...
        unverified_headline=_("eligibility.pages.unverified.login_gov.headline"),
        unverified_blurb=_("eligibility.pages.unverified.login_gov.p[0]"),
        eligibility_confirmed_headline=_("enrollment.pages.index.login_gov.eligibility_confirmed.headline"),
