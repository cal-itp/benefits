...
""",
    ...
    verifier1 = EligibilityVerifier.objects.create(
        ...
        start_item_heading=_("eligibility.pages.start.mst_login.items[0].title"),
        start_item_details=_("eligibility.pages.start.mst_login.items[0].text"),
    ...
    verifier2 = EligibilityVerifier.objects.create(
        ...
        start_item_heading=_("eligibility.pages.start.mst_cc.items[0].title"),
        start_item_details=_("eligibility.pages.start.mst_cc.items[0].text"),
