...
class EligibilityEvent(core.Event):
    ...
    def __init__(
        self, request, event_type, flow: models.EnrollmentFlow, enrollment_method=models.EnrollmentMethods.SELF_SERVICE
    ):
...
class SelectedFlowEvent(EligibilityEvent):
    ...
    def __init__(self, request, flow: models.EnrollmentFlow, enrollment_method=models.EnrollmentMethods.SELF_SERVICE):
...
class ReturnedEligibilityEvent(EligibilityEvent):
    ...
    def __init__(
        self, request, flow: models.EnrollmentFlow, status, error=None, enrollment_method=models.EnrollmentMethods.SELF_SERVICE
    ):
...
def selected_flow(request, flow: models.EnrollmentFlow, enrollment_method: str = models.EnrollmentMethods.SELF_SERVICE):
...
def started_eligibility(request, flow: models.EnrollmentFlow, enrollment_method: str = models.EnrollmentMethods.SELF_SERVICE):
...
def returned_success(request, flow: models.EnrollmentFlow, enrollment_method: str = models.EnrollmentMethods.SELF_SERVICE):
